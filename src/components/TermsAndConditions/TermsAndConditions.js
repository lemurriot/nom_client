  ...
  return (
    <section>
      ...
      <p>
        ...
        in the singular, plural, capitalisation and/or he/she or they, are taken
        as interchangeable and therefore as referring to same.
      </p>
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using NomsPDX's website you consent to
        the use of cookies in accordance with NomsPDX's privacy policy.
      </p>
      <p>
      ...
      <ol>
        ...
        <li>
          ...
          areas of the website. NomsPDX does not screen, edit, publish or review
          Comments prior to their appearance on the website and Comments do not
          reflect the views or opinions ofNomsPDX, its agents or affiliates.
          ...
          NomsPDXshall not be responsible or liable for the Comments or for any
        ...
        <li>
          You hereby grant to <strong>NomsPDX</strong> a non-exclusive
      ...
      <p>
        ...
        NomsPDX; and (d) where the link is in the context of general resource
