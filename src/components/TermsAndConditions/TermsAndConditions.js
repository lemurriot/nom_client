  ...
  return (
    <main className="page">
      ...
      <section className="page-content-container content-container terms-content-container">
        ...
        <p>You must not:</p>
        <ol>
          <li>Republish material from https://nomspdx.com/</li>
          <li>Sell, rent or sub-license material from https://nomspdx.com/</li>
          <li>
            Reproduce, duplicate or copy material from https://nomspdx.com/
          </li>
        </ol>
        <p>
        ...
        <p>
          ...
          outweighs the absence of NomsPDX; and (d) where the link is in the
