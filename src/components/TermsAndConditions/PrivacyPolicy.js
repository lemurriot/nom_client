...
function PrivacyPolicy() {
  ...
  return (
    <main className="page">
      ...
      <p>
        Like most website operators, NomsPDX collects non-personally-identifying
        ...
        site, and the date and time of each visitor request. NomsPDX's purpose
        in collecting non-personally identifying information is to better
        understand how NomsPDX's visitors use its website. From time to time,
        NomsPDX may release non-personally-identifying information in the
      ...
      <p>
        ...
        leaving comments on https://nomspdx.papershack.now.sh/ blog posts.
        NomsPDX only discloses logged in user and commenter IP addresses under
      ...
      <p>
        ...
        who sign up for a blog at https://nomspdx.papershack.now.sh/ to provide
      ...
      <p>
        ...
        Privacy Policy covers the use of cookies by NomsPDX and does not cover
      ...
      <h2>
        Https://nomspdx.papershack.now.sh/ uses Google AdWords for remarketing
      </h2>
      <p>
        Https://nomspdx.papershack.now.sh/ uses the remarketing services to
      ...
      <p>
        ...
        using NomsPDX's website, you consent to the transfer of such information
        to them. NomsPDX will not rent or sell potentially
        ...
        as described above, NomsPDX discloses potentially personally-identifying
        and personally-identifying information only in response to a subpoena,
        court order or other governmental request, or when NomsPDX believes in
        good faith that disclosure is reasonably necessary to protect the
        property or rights of NomsPDX, third parties or the public at large.
      </p>
      <p>
        If you are a registered user of https://nomspdx.papershack.now.sh/ and
        have supplied your email address, NomsPDX may occasionally send you an
        email to tell you about new features, solicit your feedback, or just
        keep you up to date with what's going on with NomsPDX and our products.
        ...
        respond to your request or to help us support other users. NomsPDX takes
      ...
      <p>
        ...
        website. NomsPDX may display this information publicly or provide it to
        others. However, NomsPDX does not disclose your personally-identifying
        information.
      </p>
      <h2>Cookies</h2>
      <p>
      ...
      <p>
        ...
        time the visitor returns. NomsPDX uses cookies to help NomsPDX identify
        and track visitors, their usage of https://nomspdx.papershack.now.sh/,
        and their website access preferences. NomsPDX visitors who do not wish
        to have cookies placed on their computers should set their browsers to
        refuse cookies before using NomsPDX's websites, with the drawback that
        certain features of NomsPDX's websites may not function properly without
        the aid of cookies.
      </p>
      <p>
        By continuing to navigate our website without changing your cookie
        settings, you hereby acknowledge and agree to NomsPDX's use of cookies.
      </p>
      <h2>E-commerce</h2>
      <p>
        Those who engage in transactions with NomsPDX – by purchasing NomsPDX's
        ...
        to process those transactions. In each case, NomsPDX collects such
        information only insofar as is necessary or appropriate to fulfill the
        purpose of the visitor's interaction with NomsPDX. NomsPDX does not
